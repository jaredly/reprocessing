...
let drawGeometry
  ...
  Gl.bindBuffer
    context::env.gl target::RGLConstants.element_array_buffer buffer::env.elementBuffer;
...
let drawLine p1::(xx1, yy1) p2::(xx2, yy2) ::color ::width ::project env => {
  ...
  addRectToGlobalBatch
    env bottomRight::(x1, y1) bottomLeft::(x2, y2) topRight::(x3, y3) topLeft::(x4, y4) ::color
};
